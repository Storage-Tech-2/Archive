...
Multi item sorter made smaller by ignoring the silent requirement. Created by RaPsCaLLioN1138, inspectortalon, CommandLeo.
## Features
- Sorts items at hopperspeed with a 40gt delay between item types.
