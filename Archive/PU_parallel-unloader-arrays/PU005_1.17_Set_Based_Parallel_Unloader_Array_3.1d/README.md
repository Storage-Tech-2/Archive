# [1.17+] Set Based Parallel Unloader Array 3.1d
...
## Notes
- Testing info, FAQ, instructions on how to adjust the system to output for signal strength 3 filters, and more in the [Manual](<https://docs.google.com/document/d/1wURZLtZx3b3m7RmgFqyuDXkxZ8FbK9xeMSmTxDZ_1F8>). Thanks to [@Passionate Storage Techer 69](# "ID: 660633169191632908") and [@Raffq](# "ID: 244529884846751745") for advice on testing.
## Sourced components
...
- set wiring by [@Kayzm](# "ID: 433358354094489612"), [@DrakePHOSE](# "ID: 183711148288245760"), & Glotz
- 2 Item Check by [@77777777777777777777](# "ID: 1068798858676686848") & [@insto](# "ID: 1055842182982021144"): https://discord.com/channels/748542142347083868/748547221338849330/1300397344134529056 ([Join Storage Tech](https://discord.gg/JufJ6uf)) [OBP003](https://discord.com/channels/1375556143186837695/1402535963061915761)
- FIT wiring by [@Raffq](# "ID: 244529884846751745"), Glotz, boyenn, & [@DrakePHOSE](# "ID: 183711148288245760")
